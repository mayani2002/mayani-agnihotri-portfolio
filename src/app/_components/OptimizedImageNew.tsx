...
export const OptimizedImage: React.FC<OptimizedImageProps> = ({
    ...
    return (
        <div className="relative w-full h-full">
            {/* Loading state */}
            {isLoading && !hasError && (
                <div className={`absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 animate-pulse flex items-center justify-center z-10 ${className}`}>
            ...
            {/* Error state */}
            {hasError && (
                <div className={`absolute inset-0 bg-red-50 dark:bg-red-900/20 border-2 border-red-200 dark:border-red-800 flex items-center justify-center z-10 ${className}`}>
